...
var KTProfileGeneral = function() {
    ...
    return {
        init: function() {
            ...
            t && t.addEventListener("click", (function(i) {
            ...
            i && i.addEventListener("click", (function(t) {
                ...
                i.disabled = !0,
                i.classList.contains("btn-success") ? setTimeout((function() {
            ...
            KTUtil.on(document.body, '[data-kt-follow-btn="true"]', "click", (function(t) {
                ...
                setTimeout((function() {
                    ...
                    e.disabled = !1,
                    e.classList.contains("btn-light-primary") ? (e.classList.remove("btn-light-primary"),
                    e.classList.add("btn-light"),
                    n.classList.remove("d-none"),
                    i.innerHTML = "Follow") : (e.classList.add("btn-light-primary"),
