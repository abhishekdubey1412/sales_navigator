...
var KTCreateCampaign = function() {
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_modal_create_campaign")) && (new bootstrap.Modal(e),
            ...
            (i = new KTStepper(t)).on("kt.stepper.changed", (function(e) {
                4 === i.getCurrentStepIndex() ? (n.classList.remove("d-none"),
                n.classList.add("d-inline-block"),
                o.classList.add("d-none")) : 5 === i.getCurrentStepIndex() ? (n.classList.add("d-none"),
                o.classList.add("d-none")) : (n.classList.remove("d-inline-block"),
            ...
            function() {
                ...
                [c, s].forEach((e => {
                    e.addEventListener("click", (t => {
                        e.classList.contains("active") || (c.classList.toggle("active"),
                        s.classList.toggle("active"),
                        s.classList.contains("active") ? d.nextElementSibling.classList.remove("d-none") : d.nextElementSibling.classList.add("d-none"))
                    }
                    ))
                }
                ));
