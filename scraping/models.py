...
class LinkedInCompany(models.Model):
    ...
    decision_makers_search_url = models.TextField(null=True, blank=True)
    employee_search_url = models.TextField(null=True, blank=True)
    decision_makers_count = models.CharField(max_length=50, null=True, blank=True)
    query = models.TextField(null=True, blank=True)
    timestamp = models.DateTimeField(auto_now_add=True)
